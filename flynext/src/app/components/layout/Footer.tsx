      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-300">
              Your most reliable travel companion for flights and hotels.
            </p>
          </div>
            ...
            <form className="mt-4">
              <div className="flex rounded-md shadow-sm">
                <input
                  ...
                  name="email"
                  id="email-address"
                  className="focus:ring-blue-500 focus:border-blue-500 block w-full rounded-l-md sm:text-sm border-gray-300 text-gray-900 p-2"
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-base text-gray-400">
            &copy; {currentYear} FlyNext. All rights reserved.
          </p>
